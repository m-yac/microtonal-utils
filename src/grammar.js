...
var grammar = {
    ...
    {"name": "top2", "symbols": ["symbExpr1"], "postprocess": d => ["symb", d[0]]},
    {"name": "top2", "symbols": ["itvExpr1"], "postprocess": d => ["interval", d[0]]},
    {"name": "top2", "symbols": ["ctsExpr1"], "postprocess": d => ["cents", d[0]]},
    {"name": "symbExpr1$string$1", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "symbExpr1", "symbols": ["symbExpr1$string$1", "_", {"literal":"("}, "_", "symbExpr1", "_", {"literal":")"}], "postprocess": d => d[4].red()},
    {"name": "symbExpr1$string$2", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"b"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "symbExpr1", "symbols": ["symbExpr1$string$2", "_", {"literal":"("}, "_", "symbExpr1", "_", {"literal":")"}], "postprocess": d => d[4].reb()},
    {"name": "symbExpr1$string$3", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "symbExpr1", "symbols": ["symbExpr1$string$3", "_", {"literal":"("}, "_", "symbExpr1", "_", {"literal":","}, "_", "itvExpr1", "_", {"literal":")"}], "postprocess": d => d[4].red(d[8])},
    {"name": "symbExpr1$string$4", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"b"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "symbExpr1", "symbols": ["symbExpr1$string$4", "_", {"literal":"("}, "_", "symbExpr1", "_", {"literal":","}, "_", "itvExpr1", "_", {"literal":")"}], "postprocess": d => d[4].reb(d[8])},
    {"name": "symbExpr1", "symbols": ["symbExpr2"], "postprocess": id},
    {"name": "symbExpr2", "symbols": ["symb"], "postprocess": id},
    {"name": "symbExpr2", "symbols": [{"literal":"("}, "_", "symbExpr1", "_", {"literal":")"}], "postprocess": d => d[2]},
    ...
    {"name": "itvExpr2$string$3", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"b"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "itvExpr2", "symbols": ["itvExpr2$string$3", "_", {"literal":"("}, "_", "itvExpr1", "_", {"literal":")"}], "postprocess": d => d[4].reb()},
    {"name": "itvExpr2$string$4", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "itvExpr2", "symbols": ["itvExpr2$string$4", "_", {"literal":"("}, "_", "itvExpr1", "_", {"literal":","}, "_", "itvExpr1", "_", {"literal":")"}], "postprocess": d => d[4].red(d[8])},
    ...
    {"name": "itvExpr3", "symbols": ["symb"], "postprocess": id},
    ...
    {"name": "ctsExpr3", "symbols": ["ctsExpr3$string$1", "_", {"literal":"("}, "_", "itvExpr1", "_", {"literal":")"}], "postprocess": d => [null, d[4]]},
    {"name": "ctsExpr3$string$2", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ctsExpr3", "symbols": ["ctsExpr3$string$2", "_", {"literal":"("}, "_", "ctsExpr1", "_", {"literal":")"}], "postprocess": d => [d[4][0], d[4][1].red()]},
    {"name": "ctsExpr3$string$3", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"b"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ctsExpr3", "symbols": ["ctsExpr3$string$3", "_", {"literal":"("}, "_", "ctsExpr1", "_", {"literal":")"}], "postprocess": d => [d[4][0], d[4][1].reb()]},
    {"name": "ctsExpr3$string$4", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ctsExpr3", "symbols": ["ctsExpr3$string$4", "_", {"literal":"("}, "_", "ctsExpr1", "_", {"literal":","}, "_", "itvExpr1", "_", {"literal":")"}], "postprocess": d => [d[8].equals(2) ? d[4][0] : null, d[4][1].red(d[8])]},
    {"name": "ctsExpr3$string$5", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"b"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ctsExpr3", "symbols": ["ctsExpr3$string$5", "_", {"literal":"("}, "_", "ctsExpr1", "_", {"literal":","}, "_", "itvExpr1", "_", {"literal":")"}], "postprocess": d => [d[8].equals(2) ? d[4][0] : null, d[4][1].reb(d[8])]},
    {"name": "ctsExpr3", "symbols": ["symb"], "postprocess": d => [null, d[0]]},
    {"name": "ctsExpr3", "symbols": ["decimal", {"literal":"c"}], "postprocess": d => [null, Interval(2).pow(Fraction(d[0]).div(1200))]},
