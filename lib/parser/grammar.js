...
var grammar = {
    ...
    {"name": "upsDnsVbNz$string$5", "symbols": [{"literal":"-"}, {"literal":"u"}, {"literal":"p"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "upsDnsVbNz", "symbols": ["posInt", "upsDnsVbNz$string$5"], "postprocess": d => parseInt(d[0])},
    {"name": "upsDnsVbNz$string$6", "symbols": [{"literal":"-"}, {"literal":"d"}, {"literal":"o"}, {"literal":"w"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "upsDnsVbNz", "symbols": ["posInt", "upsDnsVbNz$string$6"], "postprocess": d => -parseInt(d[0])},
