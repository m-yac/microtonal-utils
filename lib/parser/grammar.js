...
var grammar = {
    ...
    {"name": "intvMExpr2", "symbols": ["intvMExpr2$string$7", "_", {"literal":"("}, "_", "intvMExpr1", "_", {"literal":","}, "_", "intvMExpr1", "_", {"literal":")"}], "postprocess": d => ["!med", d[4], d[8]]},
    ...
    {"name": "pyIntv", "symbols": [{"literal":"P"}, "pyDeg"], "postprocess": (d,loc,_) => helpers.perfPyInterval(d[1],0,loc)},
    {"name": "pyIntv", "symbols": [{"literal":"M"}, "pyDeg"], "postprocess": (d,loc,_) => helpers.nonPerfPyInterval(d[1],Fraction(1,2),"M",loc)},
    {"name": "pyIntv", "symbols": [{"literal":"m"}, "pyDeg"], "postprocess": (d,loc,_) => helpers.nonPerfPyInterval(d[1],Fraction(-1,2),"m",loc)},
    ...
    {"name": "npyIntv", "symbols": ["npyIntv$subexpression$1", "pyDeg"], "postprocess": (d,loc,_) => helpers.nonPerfPyInterval(d[1],0,"n",loc)},
    ...
    {"name": "snpyIntv", "symbols": ["snpyIntv$string$1", "pyDeg"], "postprocess": (d,loc,_) => helpers.nonPerfPyInterval(d[1],Fraction(1,4),"sM",loc)},
    {"name": "snpyIntv$string$2", "symbols": [{"literal":"s"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "snpyIntv", "symbols": ["snpyIntv$string$2", "pyDeg"], "postprocess": (d,loc,_) => helpers.nonPerfPyInterval(d[1],Fraction(-1,4),"sm",loc)},
    ...
    {"name": "fjsAcc", "symbols": ["posInt"], "postprocess": (d,loc,_) => helpers.ensureNo2Or3(Interval(d[0]),loc)},
