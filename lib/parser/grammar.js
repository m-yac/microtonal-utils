...
var grammar = {
    ...
    {"name": "clrPPs", "symbols": ["clrPPsMid1", "clrPPsEnd"], "postprocess": d => d[0].concat(d[1])},
    ...
    {"name": "clrPPsMid2$string$1", "symbols": [{"literal":"-"}, {"literal":"a"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "clrPPsMid2", "symbols": ["clrMPs", "clrPPsMid1", "clrPPsMid2$string$1"], "postprocess": d => d[1].map(i => ["pow", i, d[0]])},
