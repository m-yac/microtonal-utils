...
var grammar = {
    ...
    {"name": "aclrIntv", "symbols": ["aclrIntv$ebnf$1", "aclrM", "aclrP", "clrDeg"], "postprocess": (d,loc) => ["!clrIntv", d[0].length, d[1], d[2], d[3], loc]},
    {"name": "aclrNote", "symbols": ["aclrP", "pyNote"], "postprocess": (d,loc) => ["!clrNote", d[0], d[1], loc]},
    ...
    {"name": "aclrPP", "symbols": [{"literal":"y"}], "postprocess": d => Interval(5).pow(d[0].length)},
    {"name": "aclrPP", "symbols": [{"literal":"g"}], "postprocess": d => Interval(5).pow(-d[0].length)},
    {"name": "aclrPP", "symbols": [{"literal":"z"}], "postprocess": d => Interval(7).pow(d[0].length)},
    {"name": "aclrPP", "symbols": [{"literal":"r"}], "postprocess": d => Interval(7).pow(-d[0].length)},
    ...
    {"name": "aclrPP", "symbols": ["posInt", "aclrPP$ebnf$1"], "postprocess": (d,loc,_) => ["!aclrPP", d[0], d[1].length, loc]},
    ...
    {"name": "aclrPP", "symbols": ["posInt", "aclrPP$ebnf$2"], "postprocess": (d,loc,_) => ["!aclrPP", d[0], -d[1].length, loc]},
